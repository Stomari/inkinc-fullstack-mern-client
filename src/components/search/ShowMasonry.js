...
const ShowMansory = (props) => {
  return(
        <div className="search-grid-image-wrapper">
          ...
          {props.artistGallery && props.user && (props.user._id === props.artist._id) && <div className="search-grid-overlay" onClick={(e) => props.handleDeleteTattoo(e, props.data._id)}><img src="/images/trash-solid.svg" className="trash-ico"/></div>}
        </div>
